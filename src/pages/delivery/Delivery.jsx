...
import deliveryImg from "../../assets/imgs/delivery.jpg"
      ...
      <div className="container">
        <div className="delivery-row">
          <div className="delivery-left">
            <img src={deliveryImg} alt="rasm..." />
          </div>
          <form className='delivery-right' onSubmit={handleSubmit}>
            <div className='delivery-text'>
              <h1 className="delivery_title">{t("order")}</h1>
              <p className='delivery_title_text'>
            ...
            <div className="delivery_input">
              <input
                placeholder={t("name")}
                className="delivery_input_children"
                required
                type="text"
              />
            </div>
